...
async function main() {
  ...
  const summary = {
    ...
    spins: 0, featureResponses: 0, pickRequests: 0, states: {}, serverEvents: {}, eventStates: {}, clientEvents: {}, rewardEvents: [], errors: [],
  };
  ...
  process.stdout.write(`${JSON.stringify({ output, gameKey, spins: summary.spins, bet: summary.bet, featureResponses: summary.featureResponses, states: summary.states, serverEvents: summary.serverEvents, eventStates: summary.eventStates, rewardEvents: summary.rewardEvents.length, close: summary.close, errorCount: summary.errors.length, errors: summary.errors.slice(0, 5) }, null, 2)}\n`);
}
